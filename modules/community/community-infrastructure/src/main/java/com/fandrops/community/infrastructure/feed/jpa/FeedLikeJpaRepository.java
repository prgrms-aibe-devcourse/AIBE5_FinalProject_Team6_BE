...
public interface FeedLikeJpaRepository extends JpaRepository<FeedLikeJpaEntity, Long> {
    ...
    // 피드 목록 isLiked 일괄 조회
    List<FeedLikeJpaEntity> findByFanIdAndFeedIdIn(Long fanId, List<Long> feedIds);

    List<FeedLikeJpaEntity> findByArtistMemberIdAndFeedIdIn(Long artistMemberId, List<Long> feedIds);
