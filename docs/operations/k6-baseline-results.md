...
### 결과 (2026-06-18, Actions runner — **최신 공식 베이스라인**)

| 지표 | 결과 | 목표 | 상태 |
|---|---|---|---|
| P95 응답 시간 | **216.39ms** | < 120ms | ❌ SLO 미달 |
| 에러율 | 0.00% | < 0.1% | ✅ |
| checks 통과 | 100% (59,824 / 59,824) | — | ✅ |
| 총 요청 수 | 59,824 | — | — |

> EC2 로컬(231ms) 대비 ~7% 개선 — k6가 EC2 CPU 경합 없이 runner에서 실행된 효과.

### 결과 (2026-06-12, 4회차 — EC2 로컬 참고용)
...
<details>
<summary>측정 이력 전체</summary>

| 회차 | 날짜 | 환경 | P95 | 비고 |
|---|---|---|---|---|
| 1회 | 2026-06-12 | EC2 로컬 | 206ms | 모니터링 스택 추가 전 |
| 2회 | 2026-06-12 | EC2 로컬 | 291ms | 모니터링 스택 동시 실행 |
| 3회 | 2026-06-12 | EC2 로컬 | 287.67ms | Prometheus 스크레이프 수정 후 |
| 4회 | 2026-06-12 | EC2 로컬 | 231.01ms | Grafana 캡처 병행 |
| 5회 | 2026-06-18 | Actions runner | **216.39ms** | **최신 공식 베이스라인** |
...
| 02 피드 조회 | 정환철 | 216.39ms (Actions runner) | 0.00% | — | ❌ SLO 미달 |
