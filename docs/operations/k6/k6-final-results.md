...
> **이전 결과**: `docs/operations/k6/k6-tuned-results.md`
...
|---|---|---|---|---|---|---|
| 01 주문 동시성 | 872ms(성공) ❌ | 4.33s(성공) ❌ | 75%\* | 96.00% ❌ | 0건\*\* | 실패 |
| 02 피드 Read | 168~172ms ❌ | 276.44ms ❌ | 0.00% ✅ | 0.00% ✅ | — | 실패 |
| 03 결제 확인 | 1,940ms ✅ | 2.08s ❌ | 0.00% ✅ | 1.60% ❌ | — | 실패 |
| 04 드롭스 스파이크 | 287.31ms ✅ | 278.33ms ✅ | 99.98%\* | 99.97%\* ✅ | 0건 ✅ | 성공 |
| 05 SSE 대기열 | checks 99.33% ✅ | checks 99.33% ✅ | 0% ✅ | 0건 ✅ | — | 성공 |
| 06 통합 워크로드 | 미측정 | — | — | — | — | — |
| 07 상품 조회 처리량 | 133.45ms ❌ | 16.35ms ✅ | 0.00% ✅ | 0.00% ✅ | — | 성공 |
