...
2. github 워크플로우 기반 작업 시: @docs/ai/SHARED.md @docs/ai/personas/hyungseongbin.md @docs/ai/workflows/auto-pr.md 파일의 워크플로우에 따라 '장바구니 담기 API 및 RDB 저장 로직' 구현 시작해 줘.`
```
